...
class turn_on_robot
{
	...
	private:
		...
		ros::Publisher odom_publisher, imu_publisher, voltage_publisher,ele_sensor_publisher; //Initialize the topic publisher //初始化话题发布者
		...
		void Publish_Ele_Sensor(); //Pub the ele sensor topic //发布循迹传感器话题
