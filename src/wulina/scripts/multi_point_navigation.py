...
# ==============================================================================
WAYPOINTS = [
    {'name': '航点1',  'x':  2.270, 'y':  0.605, 'yaw':  0.022},
    {'name': '航点2',  'x':  4.540, 'y':  0.692, 'yaw':  0.022},
    {'name': '航点3',  'x':  5.650, 'y':  -0.078, 'yaw':  -1.500},
    {'name': '航点4',  'x':  5.650, 'y':  -1.270, 'yaw':  -1.500},
    {'name': '航点5',  'x':  3.440, 'y':  -2.150, 'yaw':  -3.000},
    {'name': '航点6',  'x':  3.480, 'y':  0.060, 'yaw':  1.500},
    {'name': '航点7',  'x':  0.575, 'y':  0.379, 'yaw':  -3.000},
]
# ==============================================================================
...
def main():
    ...
    rotate_threshold = rospy.get_param('~rotate_in_place_threshold', 0.1)
